/*
    ...
    *어려워 지기 때문에, 각 기능별 함수를 만들어 분리하여 만드는 것이 재사용, 수정, 유지보수에 용이하다.
...
function innerFunctionTest(){
    ...
    function outerFunc(){
        ...
        function innerFunc(){
            ...
            console.log("1. =" + a); //? 실행시 1 = ?;
            console.log("2. =" + b); //? 실행시 2 = ?;
            console.log("3. =" + c); //? 실행시 3 = ?;
        }
        innerFunc();
    }
    outerFunc();
}
//? 실행시 자신과 인접한 함수 내부부터 해당 변수를 찾는다. 전역 영역까지 존재 하지 않을 시 undefined.
