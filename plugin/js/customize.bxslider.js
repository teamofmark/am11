$(document).ready(function(){
    $(".bxslider").bxSlider({
        ...
        stopAutoOnClick: true, //? controler button을 조작할 때는 자동전환 중지.
        autoControlsCombine: true, //? default : false. play/pause toggle.
        autoControlsSelector: ".newAutoControls", //? default: '', 뼈대 제공받기
        startText: '시작', //? 뼈대안 text 변경
        stopText: '중지',//? 뼈대안 text 변경

        // !carousel - 1장의 slide영역에 복수의 content(slide's)가 배치되는 slider.
        maxSlides: 3, //? default: 1. 최대 노출 슬라이드 장수.
        minSlides: 1, //? default: 1. 최소 노출 슬라이드 장수.
        slideWidth: 640, //? default: 0. carousel content 당 너비.(무조건 숫자)
        shrinkItems: false, //? max / min 기준으로 우측 일부를 남기는 UI해제.
        slideMargin: 20, //? slide간 간격 설정.(다수의 slide(carousel)를 사용시에 설정필요.) (무조건 숫자)
